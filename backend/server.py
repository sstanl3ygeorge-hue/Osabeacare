...
# Phase 1: Core Backend for Continuous Workforce Monitoring
#
...
#
# CRITICAL CONSTRAINTS:
# - Reuses existing expiry/due logic patterns
# - Reuses existing notification engine
# - Does NOT duplicate employee truth
# - Every item must be: assigned, due-dated, statused, auditable, repeatable
# - No loose notes without due dates or owners
...
# Pydantic Models for Recurring Compliance
...
@api_router.post("/recurring-compliance")
...
@api_router.get("/recurring-compliance")
...
@api_router.get("/recurring-compliance/dashboard-summary")
...
@api_router.get("/recurring-compliance/{item_id}")
...
@api_router.put("/recurring-compliance/{item_id}")
...
@api_router.post("/recurring-compliance/{item_id}/complete")
...
@api_router.get("/employees/{employee_id}/recurring-compliance")
...
# ==================== RECURRING COMPLIANCE REMINDER PROCESSING ====================
...
@api_router.post("/recurring-compliance/process-reminders")
