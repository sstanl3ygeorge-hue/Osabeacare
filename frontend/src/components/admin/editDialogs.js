// Universal Edit Components with Reason Logging
// For CQC Compliance - All edits require a reason for audit trail

export { default as EditReasonDialog } from './EditReasonDialog';
